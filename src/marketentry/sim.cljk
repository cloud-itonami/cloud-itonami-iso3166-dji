...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (DJI, clean) ==")
    ...
    (println "== jurisdiction/assess eng-5 (sets up rccm-registration-unverified) ==")
    ...
    (println "== filing/submit eng-5 (rccm-registration-unverified -> HARD hold) ==")
